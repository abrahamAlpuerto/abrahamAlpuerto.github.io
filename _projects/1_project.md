...
### Key Innovations
* **Separation of Reasoning & Calculation:** LLMs (like GPT-4o) are used *only* for reasoning and code generation. All numerical calculations are delegated to deterministic tools (Python/Pandas) to prevent "hallucination" in financial calculations.
