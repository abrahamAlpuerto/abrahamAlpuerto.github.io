...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/stock/mlpipeline.jpg" title="Data Pipeline" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/stock/modelarchitecture.jpg" title="LSTM Architecture" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
