...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/graph1.png" title="40-Day Prediction Window" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/graph2.png" title="40-Day Prediction Window" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
